...
A modern, offline-first PWA application for managing student attendance records. Teachers can mark attendance, track historical data, generate reports, and export data as PDF or images—all without requiring internet connectivity.
